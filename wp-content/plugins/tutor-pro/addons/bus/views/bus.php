...
$bus           = get_generated_bus( 'all', $course_id );
$final_grade      = get_generated_bus( 'final', $course_id );
$assignment_grade = get_assignment_bus_by_course( $course_id );
$quiz_grade       = get_quiz_bus_by_course( $course_id );
...
if ( ! $quiz_grade || ! tutor_utils()->count( $bus ) ) {
	tutor_utils()->tutor_empty_state( __( 'No Bus Data', 'tutor-pro' ) );
	return;
}
?>

<div class="tutor-bus">
	<div class="tutor-bus-finalgrade tutor-px-32 tutor-py-28">
		<div class="tutor-d-flex tutor-align-center">
			...
			<span class="tutor-bus-grade-badge tutor-bus-grade-badge-lg" style='<?php echo !empty($grade_color) ? "background-color: {$grade_color}; color: #FFFFFF; border-color: {$grade_color};" : ""; ?>'>
	...
	<div class="tutor-bus-grades tutor-mt-24">
		<div class="tutor-bus-grades-head tutor-fs-6 tutor-color-secondary tutor-d-none tutor-d-lg-block tutor-px-16 tutor-mb-12">
			<div class="tutor-row">
		...
		<div class="tutor-bus-grades-body">
			<?php foreach ( $bus as $key => $grade ) : ?>
				<?php $stat = tutor_generate_grade_html( $grade, null ); ?>
				<div class="tutor-bus-grade tutor-card tutor-p-12<?php echo ( $key > 0 ) ? ' tutor-mt-12' : ''; ?>">
					<div class="tutor-row tutor-align-center">
						...
						<div class="tutor-col-auto">
							<span class="tutor-px-16">
								...
								<span class="tutor-bus-grade-badge" style='<?php echo !empty($grade_color) ? "color: {$grade_color}; border-color: {$grade_color};" : ""; ?>'>
